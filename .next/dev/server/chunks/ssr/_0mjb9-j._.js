    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useLayoutEffect"])(()=>{
        ...
        mm.add({
            ...
            if (window.matchMedia("(prefers-reduced-motion: no-preference)").matches) {
                ...
                gsap.utils.toArray(".about-content > div, .project-feature, .partner-list > div, .moment-wall .photo-slot").forEach((el)=>{
                    gsap.fromTo(el, {
                        y: 40,
                        opacity: 0
                    }, {
                ...
                gsap.utils.toArray(".photo-slot-inset").forEach((el)=>{
                    gsap.fromTo(el, {
...
function SiteHeader() {
    ...
    const formUrl = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$site$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["microsoftFormEmbedUrl"].replace("&embed=true", "");
...
//# sourceMappingURL=_0mjb9-j._.js.map